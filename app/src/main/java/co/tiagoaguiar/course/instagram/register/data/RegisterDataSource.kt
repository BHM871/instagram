...
interface RegisterDataSource {
    ...
    fun updateUser(userUUID: String, photoUri: Uri, callback: RequestCallback<Photo>) { throw UnsupportedOperationException() }

    fun fetchSession() : UserAuth { throw UnsupportedOperationException() }
    fun putNewUser(response: UserAuth) { throw UnsupportedOperationException() }
    fun putNewPhoto(response: Photo){ throw UnsupportedOperationException() }
}